...
5.  (Optional) You can also install btcrd to your path:
...
If you are building `btcrd` or `btcr-qt` for others, your build machine should be set up
...
Once dependencies are compiled, see release-process.md for how the btcr-Qt.app
...
commands:
    ...
    echo -e "rpcuser=btcrrpc\nrpcpassword=$(xxd -l 16 -p /dev/urandom)" > "/Users/${USER}/Library/Application Support/btcr/btcr.conf"
    chmod 600 "/Users/${USER}/Library/Application Support/btcr/btcr.conf"

The next time you run it, it will start downloading the blockchain, but it won't
output anything while it's doing this. This process may take several hours;
you can monitor its process by looking at the debug.log file, like this:

    tail -f $HOME/Library/Application\ Support/btcr/debug.log
