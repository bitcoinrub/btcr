...
In order to support loading of multiple wallets in btca-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is btca.cpp.
...
Changes to btca.cpp
----------------------
btca.cpp is the entry point into btca-qt, and as such, will require some minor modifications to provide hooks for
