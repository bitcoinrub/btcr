...
This mechanism has been integrated into Bitcore-Node-btca which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/forking-altcoins/insight-api-btca#web-socket-api](https://github.com/forking-altcoins/insight-api-btca#web-socket-api) 
* API: [https://github.com/forking-altcoins/insight-api-btca#swifttx-transactions](https://github.com/forking-altcoins/insight-api-btca#swifttx-transactions) 
...
By default, the btca Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the btca Core daemon:
