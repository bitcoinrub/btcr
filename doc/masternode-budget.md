...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<btcr_address\> \<monthly_payment_btcr\> [use_ix(true|false)]
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<btcr_address\> \<monthly_payment_btcr\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` btcr.
