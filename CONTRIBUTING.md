...
The btcr Core project operates an open contributor model where anyone is
...
The following applies to code changes to the btcr Core project, and is not to be
confused with overall btcr Network Protocol consensus changes.

Whether a pull request is merged into btcr Core rests with the project merge
...
Patches that change btcr consensus rules are considerably more involved than
...
Where a patch set proposes to change the btcr consensus, it must have been
