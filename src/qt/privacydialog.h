...
public:
    ...
    void setZbtcrControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzbtcr_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzbtcr_clicked();
    void on_pushButtonZbtcrControl_clicked();
