                                                    ...
                                                    transactionView(0)
{
    ...
    */
    ...
    /*
	typeWidget->addItem(tr("Minted"), TransactionFilterProxy::TYPE(TransactionRecord::StakeMint) | TransactionFilterProxy::TYPE(TransactionRecord::StakeZbtcr));
    */
	typeWidget->addItem(tr("Masternode Reward"), TransactionFilterProxy::TYPE(TransactionRecord::MNReward));
    /*
	typeWidget->addItem(tr("Received btcr from zbtcr"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zbtcr"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zbtcr));
