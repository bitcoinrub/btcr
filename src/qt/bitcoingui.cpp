                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("btcr Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About btcr Core"), this);
    aboutAction->setStatusTip(tr("Show information about btcr Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Gentaium Core help message to get a list with possible btcr command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("btcr Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("btcr Core"); // default title
