                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("btca Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a btca address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and btca: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About btca Core"), this);
    aboutAction->setStatusTip(tr("Show information about btca Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for btca"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your btca addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified btca addresses"));
    ...
    openAction->setStatusTip(tr("Open a btca: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Gentaium Core help message to get a list with possible btca command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("btca Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to btca network", "", count));
}
...
{
    QString strTitle = tr("btca Core"); // default title
